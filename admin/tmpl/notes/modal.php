...
/** @var \TrueChristianBible\Component\GetBible\Administrator\View\Notes\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_getbible&view=notes&layout=modal&tmpl=component&titleKey=' . $this->getModalTitleKey()); ?>" method="post" name="adminForm" id="adminForm">
