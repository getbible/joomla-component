...
/** @var \TrueChristianBible\Component\GetBible\Administrator\View\Prompts\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_getbible&view=prompts&layout=modal&tmpl=component&titleKey=' . $this->getModalTitleKey()); ?>" method="post" name="adminForm" id="adminForm">
