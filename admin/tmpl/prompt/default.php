...
<div class="main-card">
	...
	<?php echo Html::_('uitab.addTab', 'promptTab', 'open_ai', Text::_('COM_GETBIBLE_PROMPT_OPEN_AI', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'promptTab', 'publishing', Text::_('COM_GETBIBLE_PROMPT_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
