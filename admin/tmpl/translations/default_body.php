...
<?php foreach ($this->items as $i => $item): ?>
	<?php
		...
		$canDo = Actions::get('translation', $item, 'translations');
	?>
	<tr class="row<?php echo $i % 2; ?>">
		<td class="order nowrap center hidden-phone">
		<?php if (!$this->isModal && $canDo->get('translation.edit.state')): ?>
			<?php
				$iconClass = '';
				if (!$this->saveOrder)
				{
		...
		<?php if (!$this->isModal && $canDo->get('translation.edit')): ?>
				...
				<?php else: ?>
					...
					<?php else: ?>
						<?php
							...
							$itemHtml = '<a href="' . $this->escape($link, false) . '">' . $this->escape($item->translation, false) . '</a>';
							$attribs = 'data-content-select data-content-type="com_getbible.translation"'
								. ' data-id="' . $dataId . '"'
								. ' data-title="' . $this->escape($item->translation, false) . '"'
