...
class GetbibleModelOpen_ai_message extends AdminModel
{
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'open_ai_message', $prefix = 'GetbibleTable', $config = [])
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_getbible.edit.open_ai_message.data', []);
