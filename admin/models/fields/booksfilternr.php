 ...
 */
class JFormFieldBooksfilternr extends JFormFieldList
{
	/**
	...
	protected function getOptions()
	{
		...
		$_filter = array();
		$_filter[] = JHtml::_('select.option', '', '- ' . JText::_('COM_GETBIBLE_FILTER_SELECT_NUMBER') . ' -');
		...
		if ($_results)
		{
			...
			foreach ($_results as $nr)
			{
				...
				$_filter[] = JHtml::_('select.option', $nr, $nr);
			}
		}
		return $_filter;
	}
