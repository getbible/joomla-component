 ...
 */
class JFormFieldVersesfilterchapter extends JFormFieldList
{
	/**
	 * The versesfilterchapter field type.
	 *
	 * @var        string
	 */
	public $type = 'versesfilterchapter';
	...
	protected function getOptions()
	{
		...
		$_filter = [];
		$_filter[] = Html::_('select.option', '', '- ' . Text::_('COM_GETBIBLE_FILTER_SELECT_CHAPTER') . ' -');
