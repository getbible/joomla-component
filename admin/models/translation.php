 ...
 */
class GetbibleModelTranslation extends AdminModel
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'translation', $prefix = 'GetbibleTable', $config = array())
	{
	...
	protected function canDelete($record)
	{
		if (!empty($record->id))
		{
			...
			return $user->authorise('translation.delete', 'com_getbible.translation.' . (int) $record->id);
		}
		return false;
	}
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_getbible.edit.translation.data', array());
	...
	public function save($data)
	{
		...
		elseif (!isset($data['distribution_history'])
			&& JFactory::getUser()->authorise('translation.edit.distribution_history', 'com_getbible'))
		{
