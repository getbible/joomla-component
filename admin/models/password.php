 ...
 */
class GetbibleModelPassword extends AdminModel
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'password', $prefix = 'GetbibleTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true, $options = array('control' => 'jform'))
	{
			...
			|| ($id == 0 && !$user->authorise('password.view.password', 'com_getbible')))
		{
			...
			elseif (GetbibleHelper::checkArray($val))
			{
	...
	protected function canDelete($record)
	{
		if (!empty($record->id))
		{
			...
			return $user->authorise('password.delete', 'com_getbible.password.' . (int) $record->id);
		}
		return false;
	}
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		return $user->authorise('password.edit', 'com_getbible.password.'. ((int) isset($data[$key]) ? $data[$key] : 0)) or $user->authorise('password.edit',  'com_getbible');
	}
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_getbible.edit.password.data', array());
