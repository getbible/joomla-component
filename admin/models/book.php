 ...
 */
class GetbibleModelBook extends AdminModel
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'book', $prefix = 'GetbibleTable', $config = array())
	{
	...
	protected function canDelete($record)
	{
		if (!empty($record->id))
		{
			...
			return $user->authorise('book.delete', 'com_getbible.book.' . (int) $record->id);
		}
		return false;
	}
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		return $user->authorise('book.edit', 'com_getbible.book.'. ((int) isset($data[$key]) ? $data[$key] : 0)) or $user->authorise('book.edit',  'com_getbible');
	}
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_getbible.edit.book.data', array());
