...
class Open_ai_responseModel extends AdminModel
{
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'open_ai_response', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('open_ai_response.delete', 'com_getbible.open_ai_response.' . (int) $record->id);
	}
