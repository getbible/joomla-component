...
class Open_ai_messageModel extends AdminModel
{
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'open_ai_message', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('open_ai_message.delete', 'com_getbible.open_ai_message.' . (int) $record->id);
	}
