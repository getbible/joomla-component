...
class Open_ai_responseTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_getbible.open_ai_response';
		...
		parent::__construct('#__getbible_open_ai_response', 'id', $db, $dispatcher);
	}
	...
	protected function _getAssetParentId(Table $table = null, $id = null)
	{
		...
		// load the getbible asset
		$assets->loadByName('com_getbible');
