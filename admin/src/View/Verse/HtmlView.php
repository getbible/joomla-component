...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('verse', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title(Text::_('COM_GETBIBLE_VERSE_READONLY'), 'verse');
		ToolbarHelper::cancel('verse.cancel', 'JTOOLBAR_CLOSE');
	}
	...
	{
		$this->input->set('hidemainmenu', true);
		ToolbarHelper::title(Text::_('COM_COMPONENTBUILDER__VIEWNAMELANG_READONLY_'), 'verse');
		ToolbarHelper::cancel('verse.cancel', 'JTOOLBAR_CLOSE');
	}
