...
/------------------------------------------------------------------------------------------------------*/
namespace TrueChristianBible\Component\GetBible\Administrator\View\Chapter;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('chapter', $this->item);
	...
	{
		$this->input->set('hidemainmenu', true);
		ToolbarHelper::title(Text::_('COM_COMPONENTBUILDER__VIEWNAMELANG_READONLY_'), 'chapter');
		ToolbarHelper::cancel('chapter.cancel', 'JTOOLBAR_CLOSE');
	}
