...
/------------------------------------------------------------------------------------------------------*/
namespace TrueChristianBible\Component\GetBible\Administrator\View\Open_ai_message;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('open_ai_message', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title( Text::_($isNew ? 'COM_GETBIBLE_OPEN_AI_MESSAGE_NEW' : 'COM_GETBIBLE_OPEN_AI_MESSAGE_EDIT'), 'pencil-2 article-add');
		...
		if (StringHelper::check($this->referral))
		{
			if ($this->canDo->get('open_ai_message.create') && $isNew)
			{
				...
				ToolbarHelper::save('open_ai_message.save', 'JTOOLBAR_SAVE');
			}
			...
			if ($isNew)
			{
				...
				ToolbarHelper::cancel('open_ai_message.cancel', 'JTOOLBAR_CANCEL');
			}
			else
			{
				// We can close it.
				ToolbarHelper::cancel('open_ai_message.cancel', 'JTOOLBAR_CLOSE');
			}
		}
		else
		{
			if ($isNew)
			{
				...
				{
					ToolbarHelper::apply('open_ai_message.apply', 'JTOOLBAR_APPLY');
					ToolbarHelper::save('open_ai_message.save', 'JTOOLBAR_SAVE');
					ToolbarHelper::custom('open_ai_message.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
				};
				ToolbarHelper::cancel('open_ai_message.cancel', 'JTOOLBAR_CANCEL');
			}
			else
			{
				...
				{
					ToolbarHelper::versions('com_getbible.open_ai_message', $this->item->id);
				}
				if ($this->canDo->get('open_ai_message.create'))
				{
					ToolbarHelper::custom('open_ai_message.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
				}
				ToolbarHelper::cancel('open_ai_message.cancel', 'JTOOLBAR_CLOSE');
			}
		}
