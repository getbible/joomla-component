...
/------------------------------------------------------------------------------------------------------*/
namespace TrueChristianBible\Component\GetBible\Administrator\View\Translation;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('translation', $this->item);
	...
	{
		$this->input->set('hidemainmenu', true);
		ToolbarHelper::title(Text::_('COM_COMPONENTBUILDER__VIEWNAMELANG_READONLY_'), 'translation');
		ToolbarHelper::cancel('translation.cancel', 'JTOOLBAR_CLOSE');
	}
