...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.addTab', 'chapterTab', 'details', Text::_('COM_GETBIBLE_CHAPTER_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo LayoutHelper::render('chapter.details_left', $this); ?>
			</div>
			<div class="span6">
				<?php echo LayoutHelper::render('chapter.details_right', $this); ?>
			</div>
		</div>
	...
	<?php echo Html::_('bootstrap.addTab', 'chapterTab', 'publishing', Text::_('COM_GETBIBLE_CHAPTER_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo LayoutHelper::render('chapter.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo LayoutHelper::render('chapter.publlshing', $this); ?>
			</div>
		</div>
	<?php echo Html::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'chapterTab', 'permissions', Text::_('COM_GETBIBLE_CHAPTER_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
