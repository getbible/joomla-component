...
if ($this->saveOrder)
{
	...
	JHtml::_('sortablelist.sortable', 'tagList', 'adminForm', strtolower($this->listDirn), $saveOrderingUrl);
}
?>
<form action="<?php echo JRoute::_('index.php?option=com_getbible&view=tags'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php else : ?>
	...
	<?php if ($this->canCreate && $this->canEdit) : ?>
		<?php echo JHtml::_(
			...
			'collapseModal',
			array(
				'title' => JText::_('COM_GETBIBLE_TAGS_BATCH_OPTIONS'),
