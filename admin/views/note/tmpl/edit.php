...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.addTab', 'noteTab', 'details', Text::_('COM_GETBIBLE_NOTE_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo LayoutHelper::render('note.details_left', $this); ?>
			</div>
			<div class="span6">
				<?php echo LayoutHelper::render('note.details_right', $this); ?>
			</div>
		</div>
	...
	<?php echo Html::_('bootstrap.addTab', 'noteTab', 'publishing', Text::_('COM_GETBIBLE_NOTE_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo LayoutHelper::render('note.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo LayoutHelper::render('note.publlshing', $this); ?>
			</div>
		</div>
	<?php echo Html::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'noteTab', 'permissions', Text::_('COM_GETBIBLE_NOTE_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
