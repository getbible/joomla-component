...
if ($this->saveOrder)
{
	...
	Html::_('sortablelist.sortable', 'bookList', 'adminForm', strtolower($this->listDirn), $saveOrderingUrl);
}
?>
<form action="<?php echo Route::_('index.php?option=com_getbible&view=books'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php else : ?>
	...
	<?php if ($this->canCreate && $this->canEdit) : ?>
		<?php echo Html::_(
			...
			'collapseModal',
			array(
				'title' => Text::_('COM_GETBIBLE_BOOKS_BATCH_OPTIONS'),
