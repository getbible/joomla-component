...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.addTab', 'translationTab', 'details', Text::_('COM_GETBIBLE_TRANSLATION_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo LayoutHelper::render('translation.details_left', $this); ?>
			</div>
			<div class="span6">
				<?php echo LayoutHelper::render('translation.details_right', $this); ?>
			</div>
		</div>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<?php echo LayoutHelper::render('translation.details_fullwidth', $this); ?>
			</div>
		</div>
	...
	<?php echo Html::_('bootstrap.addTab', 'translationTab', 'publishing', Text::_('COM_GETBIBLE_TRANSLATION_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo LayoutHelper::render('translation.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo LayoutHelper::render('translation.publlshing', $this); ?>
			</div>
		</div>
	<?php echo Html::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'translationTab', 'permissions', Text::_('COM_GETBIBLE_TRANSLATION_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
