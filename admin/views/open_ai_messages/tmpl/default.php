...
if ($this->saveOrder)
{
	...
	Html::_('sortablelist.sortable', 'open_ai_messageList', 'adminForm', strtolower($this->listDirn), $saveOrderingUrl);
}
?>
<form action="<?php echo Route::_('index.php?option=com_getbible&view=open_ai_messages'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php else : ?>
	...
	<?php if ($this->canCreate && $this->canEdit) : ?>
		<?php echo Html::_(
			...
			'collapseModal',
			array(
				'title' => Text::_('COM_GETBIBLE_OPEN_AI_MESSAGES_BATCH_OPTIONS'),
