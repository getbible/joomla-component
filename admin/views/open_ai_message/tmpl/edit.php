...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.addTab', 'open_ai_messageTab', 'publishing', Text::_('COM_GETBIBLE_OPEN_AI_MESSAGE_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'open_ai_messageTab', 'permissions', Text::_('COM_GETBIBLE_OPEN_AI_MESSAGE_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
