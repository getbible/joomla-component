...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.addTab', 'open_ai_responseTab', 'prompt', Text::_('COM_GETBIBLE_OPEN_AI_RESPONSE_PROMPT', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'open_ai_responseTab', 'bible', Text::_('COM_GETBIBLE_OPEN_AI_RESPONSE_BIBLE', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'open_ai_responseTab', 'message', Text::_('COM_GETBIBLE_OPEN_AI_RESPONSE_MESSAGE', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
		</div>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
	...
	<?php echo Html::_('bootstrap.addTab', 'open_ai_responseTab', 'publishing', Text::_('COM_GETBIBLE_OPEN_AI_RESPONSE_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'open_ai_responseTab', 'permissions', Text::_('COM_GETBIBLE_OPEN_AI_RESPONSE_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
