...
CREATE TABLE IF NOT EXISTS `#__getbible_open_ai_response` (
	...
	`response_created` VARCHAR(255) NULL,
	`response_id` VARCHAR(255) NULL,
	`response_model` VARCHAR(255) NULL,
	`response_object` VARCHAR(255) NULL,
	`selected_word` TEXT NULL,
	`temperature` FLOAT(11) NOT NULL DEFAULT 0,
	`top_p` FLOAT(11) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__getbible_translation` (
	`id` INT(11) NOT NULL AUTO_INCREMENT,
	`asset_id` INT(10) unsigned NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
	`abbreviation` VARCHAR(64) NULL DEFAULT '',
	`direction` VARCHAR(64) NOT NULL DEFAULT '',
	`distribution_abbreviation` VARCHAR(64) NULL DEFAULT '',
	`distribution_about` TEXT NULL,
	`distribution_history` TEXT NOT NULL,
	`distribution_lcsh` VARCHAR(64) NULL DEFAULT '',
	`distribution_license` TEXT NULL,
	`distribution_source` TEXT NULL,
	`distribution_sourcetype` VARCHAR(255) NULL DEFAULT '',
	`distribution_versification` VARCHAR(64) NULL DEFAULT '',
	`distribution_version` VARCHAR(64) NULL DEFAULT '',
	`distribution_version_date` VARCHAR(64) NULL DEFAULT '',
	`encoding` VARCHAR(64) NULL DEFAULT '',
	`lang` VARCHAR(255) NULL DEFAULT '',
	`language` VARCHAR(100) NULL DEFAULT '',
	`sha` VARCHAR(64) NULL DEFAULT '',
	`translation` VARCHAR(255) NULL DEFAULT '',
	`params` TEXT NULL,
	`published` TINYINT(3) NULL DEFAULT 1,
	`created_by` INT unsigned NULL,
	`modified_by` INT unsigned,
