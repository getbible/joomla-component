...
class Com_GetbibleInstallerScript
{
	...
	public function uninstall(ComponentAdapter $parent)
	{
		...
		if ($getbible_removed_done)
		{
			...
			$app->enqueueMessage(Text::_('The com_getbible extension was removed from the <b>#__action_logs_extensions</b> table'));
		}
		...
		if ($linker_action_log_config_done)
		{
			...
			$app->enqueueMessage(Text::_('The com_getbible.linker type alias was removed from the <b>#__action_log_config</b> table'));
		}
		...
		if ($note_action_log_config_done)
		{
			...
			$app->enqueueMessage(Text::_('The com_getbible.note type alias was removed from the <b>#__action_log_config</b> table'));
		}
		...
		if ($tagged_verse_action_log_config_done)
		{
			...
			$app->enqueueMessage(Text::_('The com_getbible.tagged_verse type alias was removed from the <b>#__action_log_config</b> table'));
		}
		...
		if ($prompt_action_log_config_done)
		{
			...
			$app->enqueueMessage(Text::_('The com_getbible.prompt type alias was removed from the <b>#__action_log_config</b> table'));
		}
		...
		if ($open_ai_response_action_log_config_done)
		{
			...
			$app->enqueueMessage(Text::_('The com_getbible.open_ai_response type alias was removed from the <b>#__action_log_config</b> table'));
		}
		...
		if ($open_ai_message_action_log_config_done)
		{
			...
			$app->enqueueMessage(Text::_('The com_getbible.open_ai_message type alias was removed from the <b>#__action_log_config</b> table'));
		}
		...
		if ($password_action_log_config_done)
		{
			...
			$app->enqueueMessage(Text::_('The com_getbible.password type alias was removed from the <b>#__action_log_config</b> table'));
		}
		...
		if ($tag_action_log_config_done)
		{
			...
			$app->enqueueMessage(Text::_('The com_getbible.tag type alias was removed from the <b>#__action_log_config</b> table'));
		}
		...
		if ($translation_action_log_config_done)
		{
			...
			$app->enqueueMessage(Text::_('The com_getbible.translation type alias was removed from the <b>#__action_log_config</b> table'));
		}
		...
		if ($book_action_log_config_done)
		{
			...
			$app->enqueueMessage(Text::_('The com_getbible.book type alias was removed from the <b>#__action_log_config</b> table'));
		}
		...
		if ($chapter_action_log_config_done)
		{
			...
			$app->enqueueMessage(Text::_('The com_getbible.chapter type alias was removed from the <b>#__action_log_config</b> table'));
		}
		...
		if ($verse_action_log_config_done)
		{
			...
			$app->enqueueMessage(Text::_('The com_getbible.verse type alias was removed from the <b>#__action_log_config</b> table'));
		}
	...
	public function postflight($type, ComponentAdapter $parent)
	{
		...
		if ($type === 'install')
		{
			...
			$note->content_history_options = '{"formFile": "administrator/components/com_getbible/models/forms/note.xml","hideFields": ["asset_id","checked_out","checked_out_time","version"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","version","hits","book_nr","access","verse","chapter"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "linker","targetTable": "#__getbible_linker","targetColumn": "guid","displayColumn": "name"}]}';
			...
			$tagged_verse->content_history_options = '{"formFile": "administrator/components/com_getbible/models/forms/tagged_verse.xml","hideFields": ["asset_id","checked_out","checked_out_time","version"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","version","hits","book_nr","access","verse","chapter"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "abbreviation","targetTable": "#__getbible_translation","targetColumn": "abbreviation","displayColumn": "translation"},{"sourceColumn": "linker","targetTable": "#__getbible_linker","targetColumn": "guid","displayColumn": "name"},{"sourceColumn": "tag","targetTable": "#__getbible_tag","targetColumn": "guid","displayColumn": "name"}]}';
			...
			$open_ai_message->content_history_options = '{"formFile": "administrator/components/com_getbible/models/forms/open_ai_message.xml","hideFields": ["asset_id","checked_out","checked_out_time","version"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","version","hits","source","index"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "open_ai_response","targetTable": "#__getbible_open_ai_response","targetColumn": "response_id","displayColumn": "response_id"},{"sourceColumn": "prompt","targetTable": "#__getbible_prompt","targetColumn": "guid","displayColumn": "name"}]}';
			...
			$tag->content_history_options = '{"formFile": "administrator/components/com_getbible/models/forms/tag.xml","hideFields": ["asset_id","checked_out","checked_out_time","version"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","version","hits","access"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "linker","targetTable": "#__getbible_linker","targetColumn": "guid","displayColumn": "name"}]}';
		...
		if ($type === 'update')
		{
			...
			echo '<div style="background-color: #fff;" class="alert alert-info"><a target="_blank" href="https://getbible.net" title="Get Bible">
				...
				<h3>Upgrade to Version 3.1.3-alpha2 Was Successful! Let us know if anything is not working as expected.</h3></div>';
	...
	protected function classExists(string $className): bool
	{
		...
		$autoloaders = [
			...
			JPATH_ADMINISTRATOR . '/components/com_getbible/helpers/powerloader.php'
		];
