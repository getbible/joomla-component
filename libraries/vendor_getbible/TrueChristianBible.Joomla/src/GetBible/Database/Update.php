...
namespace TrueChristianBible\Joomla\GetBible\Database;


use TrueChristianBible\Joomla\GetBible\Model\Upsert as Model;
use TrueChristianBible\Joomla\Database\Update as Database;
