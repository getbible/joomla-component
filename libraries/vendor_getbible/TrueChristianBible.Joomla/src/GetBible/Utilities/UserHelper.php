...
namespace TrueChristianBible\Joomla\GetBible\Utilities;
...
use TrueChristianBible\Joomla\Utilities\Component\Helper as Component;
use TrueChristianBible\Joomla\Utilities\ArrayHelper;
use TrueChristianBible\Joomla\Utilities\StringHelper;
use TrueChristianBible\Joomla\GetBible\Utilities\Exception\NoUserIdFoundException;
...
abstract class UserHelper
{
		...
		array $params = ['useractivation' => 0, 'sendpassword' => 1], int $mode = 1): int
	{
		...
		{
			throw new \InvalidArgumentException(Text::_('COM_GETBIBLE_CAN_NOT_SAVE_USER_WITHOUT_EMAIL_VALUE'));
		}
		...
		array $params = ['useractivation' => 0, 'sendpassword' => 1], int $mode = 1): int
	{
		...
		if ($mode === 2 && method_exists(GetbibleHelper::class, 'registerUser'))
		{
			$params['autologin'] = $autologin;
			$userId = GetbibleHelper::registerUser($credentials, $params);
			...
			throw new NoUserIdFoundException(Text::_('COM_GETBIBLE_USER_CREATION_FAILED'));
		}
		...
		throw new NoUserIdFoundException(
			Text::sprintf('COM_GETBIBLE_USER_S_S_CREATION_FAILEDS',
	...
	public static function update(array $userDetails): int
	{
		...
		throw new \RuntimeException(
			Text::sprintf('COM_GETBIBLE_UPDATE_OF_USER_S_S_FAILEDS',
