...
namespace TrueChristianBible\Joomla\Github\Service;


use Joomla\DI\Container;
use Joomla\DI\ServiceProviderInterface;
use TrueChristianBible\Joomla\Utilities\Component\Helper;
use TrueChristianBible\Joomla\Github\Utilities\Http;
use TrueChristianBible\Joomla\Github\Utilities\Uri;
use TrueChristianBible\Joomla\Github\Utilities\Response;
...
class Utilities implements ServiceProviderInterface
{
	...
	{
		return new Http(
			Helper::getParams('com_getbible')->get('github_access_token') ?? null
		);
	}
