	...
	public function postflight(string $type, InstallerAdapter $adapter): bool
	{
		...
		if ($type === 'update')
		{
			...
			echo '<div style="background-color: #fff;" class="alert alert-info"><a target="_blank" href="https://getbible.net" title="Get Bible">
				...
				<h3>Upgrade to Version 4.0.15-beta1 Was Successful! Let us know if anything is not working as expected.</h3></div>';
