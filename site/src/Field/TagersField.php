...
/------------------------------------------------------------------------------------------------------*/
namespace TrueChristianBible\Component\GetBible\Site\Field;
...
class TagersField extends ListField
{
	...
	protected function getInput()
	{
		...
		if ($set_button === 'true')
		{
			...
			{
				// build Create button
				$button[] = '<a id="'.$button_code_name.'Create" class="btn btn-small btn-success hasTooltip" title="'.Text::sprintf('COM_GETBIBLE_CREATE_NEW_S', $button_label).'" style="border-radius: 0px 4px 4px 0px;"
