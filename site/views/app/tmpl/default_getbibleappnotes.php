...
<div id="getbible-app-notes" class="uk-modal-container" uk-modal>
	<div class="uk-modal-dialog uk-modal-body">
		...
		<div class="uk-margin uk-margin-remove-top">
			...
			<span class="uk-text-small uk-text-muted uk-margin-remove"><?php echo JText::_('COM_GETBIBLE_NOTES_ON_THIS_VERSE'); ?></span>
		</div>
		...
		<?php $this->modalState->oneText = JText::_('COM_GETBIBLE_TAGS'); ?>
