...
<ul class="uk-list uk-list-circle uk-list-collapse uk-list-muted">
	<?php if (isset($this->translation->encoding) && strlen($this->translation->encoding) > 0): ?>
		<li><?php echo JText::_('COM_GETBIBLE_ENCODING'); ?>: <?php echo $this->translation->encoding;  ?></li>
	<?php endif; ?>
	<?php if (isset($this->translation->direction) && strlen($this->translation->direction) > 0): ?>
		<li><?php echo JText::_('COM_GETBIBLE_DIRECTION'); ?>: <?php echo $this->translation->direction;  ?></li>
	<?php endif; ?>
	...
	<?php if (isset($this->translation->distribution_abbreviation) && strlen($this->translation->distribution_abbreviation) > 0): ?>
		<li><?php echo JText::_('COM_GETBIBLE_DISTRIBUTION_ABBREVIATION'); ?>: <?php echo $this->translation->distribution_abbreviation;  ?></li>
	<?php endif; ?>
</ul>
<h4><?php echo JText::_('COM_GETBIBLE_LICENSE'); ?></h4>
<p><?php echo $this->translation->distribution_license; ?></p>
<h4><?php echo JText::_('COM_GETBIBLE_SOURCE'); ?> (<?php echo $this->translation->distribution_sourcetype; ?>)</h4>
